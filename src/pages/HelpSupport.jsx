...
const faqItems = [
  {
    ...
    answer: 'When you search for an activity partner in Explore, we automatically find users with matching interests and availability. Connection requests are sent to compatible matches, and you can start chatting once both parties accept.',
  },
  {
    question: 'How do I start a chat with someone?',
    answer: 'Chats begin when a connection request is accepted. You can receive requests on your Home page and accept them to start messaging. You can also join community chats by joining a community.',
  },
  {
    question: 'How do I change my preferences?',
    answer: 'Go to your Profile page and tap "Edit Preferences" to update your interests, comfort level, availability, and other settings that help us find better matches for you.',
  },
  {
    question: 'How do I create an event?',
    answer: 'Tap the "+" button on the Home page to create a new event. Fill in the activity type, title, description, date and time. Your event will be visible to other users with matching interests.',
  },
  {
    question: 'How do I join a community?',
    answer: 'Browse communities on the Explore page or Home page. Click "Join Community" on any community card to become a member. You\'ll automatically get access to the community chat.',
  },
  {
    question: 'Is my data safe?',
    answer: 'Yes! We take privacy seriously. Your personal information is encrypted and never shared without your consent. You control what\'s visible on your profile.',
  },
]
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">support@socialsphere.app</p>
                </div>
              </a>
            </div>
          </div>
