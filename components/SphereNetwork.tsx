...
interface NetworkSphereProps {
	...
	isHovered: boolean;
	onPositionUpdate: (id: string, position: SpherePosition) => void;
}
		...
		>
			...
			{connections.map((conn) => {
				...
				const isConnectedToHovered =
					hoveredSphere === conn.from || hoveredSphere === conn.to;
					...
					<line
						...
						stroke={
							isConnectedToHovered
								? "url(#lineGradientHover)"
								: "url(#lineGradientDefault)"
						}
...
export default function SphereNetwork() {
	...
	const handleHover = useCallback((id: string, isHovered: boolean) => {
		setHoveredSphere(isHovered ? id : null);
	}, []);

	const handlePositionUpdate = useCallback(
		(id: string, position: SpherePosition) => {
